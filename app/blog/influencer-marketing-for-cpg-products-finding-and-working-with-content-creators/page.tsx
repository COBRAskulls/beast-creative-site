        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20">
          <AnimatedSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <a href="/blog/cpg-brand-refresh-when-and-how-to-rebrand-your-consumer-packaged-goods" className="group block bg-beast-white rounded-2xl border border-light-border p-6 hover:shadow-[0_8px_32px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300">
                <div className="flex items-center gap-2 mb-3">
                  <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-light-surface text-[#717171]">CPG Marketing</span>
                ...
                <p className="text-[#717171] text-sm leading-relaxed mb-4">Nearly 73% of CPG brands that undergo strategic rebranding see measurable sales growth within 18 months, yet most consum</p>
                <div className="flex items-center justify-between pt-3 border-t border-light-border">
                  <span className="text-xs text-[#717171]">February 9, 2026</span>
                  <span className="text-beast-pink text-sm font-semibold">Read →</span>
                </div>
              </a>
            </div>
