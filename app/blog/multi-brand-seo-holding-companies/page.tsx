...
const faqs = [
  {
    ...
    answer:
      "Multi-brand SEO is the practice of managing search optimization across a portfolio of brands under a single parent company — ensuring each brand builds independent authority while the holding company benefits from a unified domain strategy.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Domain architecture changes show results in 3–6 months as domain authority consolidates. Keyword ranking improvements typically follow 2–4 weeks after technical implementation. The long-term compounding effect of unified authority builds over 12–24 months.",
  },
  {
    question: "What is an entity relationship map in SEO?",
    answer:
      "An entity relationship map is a structured document that defines how each brand, product, and content asset in your portfolio relates to the others in Google's Knowledge Graph. It's used to implement structured data (schema.org) that tells search engines — and AI tools — exactly how your brands are connected.",
  },
];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            headline:
              "Multi-Brand SEO: Why Holding Companies Are Cannibalizing Their Own Search Rankings",
            description:
              "If you manage 3+ consumer brands on separate domains, you're likely cannibalizing your own search rankings.",
