        ...
        <div className="relative max-w-4xl mx-auto px-6 lg:px-20">
          <AnimatedSection>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-xs text-[#717171]">March 14, 2026 · 8 min read</span>
            </div>
          ...
          <AnimatedSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <a href="/blog/digital-marketing-strategies-for-cpg-brands-a-complete-2025-guide" className="group block bg-beast-white rounded-2xl border border-light-border p-6 hover:shadow-[0_8px_32px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300">
                ...
                <p className="text-[#717171] text-sm leading-relaxed mb-4">Consumer packaged goods brands face a unique challenge — convincing shoppers to choose their product in the three second</p>
                <div className="flex items-center justify-between pt-3 border-t border-light-border">
